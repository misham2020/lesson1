...
/**
 * Class rest_monitoring
 */
class rest_monitoring extends CModule
{
    /**
     * Индификатор модуля
     * @var string
     */
    public $MODULE_ID = 'rest.monitoring';

    /**
     * rest_monitoring constructor.
     */
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('YLAB_CKECKUP_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('YLAB_CKECKUP_MODULE_DESCRIPTION');
